...
//
//import com.example.QueApplication.Controller.BranchController;
//import com.example.QueApplication.DTO.*;
//import com.example.QueApplication.Entity.*;
//import com.example.QueApplication.Exception.QueueException;
//import com.example.QueApplication.Repository.*;
//import com.example.QueApplication.Services.EmployeeService;
...
//
//            return BranchController.getPage(employeesInBranches, pageable);
//        }
//    }
//
//@Override
...
//            .filter(Optional::isPresent)
//            .map(Optional::get)
//            .map(service -> new ServiceDTO(service.getId(), service.getName()))
//            .collect(Collectors.toList());
//
...
//    }
//    @Override
//    public Employee assignCounter(String employeeId, String counterId) {
...
//        auditLogs.setOldData(employee.getCounter() != null ? employee.getCounter().getId() : null);
//        auditLogs.setNewData(counterId);
//        auditLogs.setCreatedBy("admin"); // Replace as needed
//        auditLogsRepository.save(auditLogs);
//
//        Counter counter = counterRepository.findCounterById(counterId).orElse(null);
...
//
//            Set<com.example.QueApplication.Entity.Session> empSessions;
...
////        Set<Appointment.State> stateList = Set.of(Appoi ntment.State.CONFIRMED, Appointment.State.CHECKEDIN);
////
