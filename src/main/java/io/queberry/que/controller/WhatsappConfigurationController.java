...
public class WhatsappConfigurationController {
    ...
    public WhatsappConfigurationController(WhatsappConfigurationRepository whatsappConfigurationRepository) {
        this.whatsappConfigurationRepository = whatsappConfigurationRepository;
    }
